  ...
  return (
    <div className="flex gap-8 xl:gap-12 py-10 pb-24">
      <article
        ...
        prose-pre:bg-white/[0.04] prose-pre:border prose-pre:border-white/10 prose-pre:rounded-lg prose-pre:p-6
        ...
        prose-th:text-white/80 prose-th:border-b prose-th:border-white/15 prose-th:px-4 prose-th:py-3 prose-th:text-left prose-th:text-xs prose-th:uppercase prose-th:tracking-wider
        prose-td:text-white/60 prose-td:border-b prose-td:border-white/10 prose-td:px-4 prose-td:py-3 prose-td:text-sm
      "
      >
