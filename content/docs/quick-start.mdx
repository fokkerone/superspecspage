---
title: Quick Start
description: Get SuperSpecs running in your project in under 5 minutes
order: 2
---
...
Open your agent and say: **"Tell me about your superspecs"**

The agent will confirm SuperSpecs is active and explain the available commands.
